  ...
  return (
    <>
      ...
      <Modal
        ...
        classNames={{
          backdrop:
            "bg-gradient-to-t from-pink-900/50 to-purple-900/50 backdrop-opacity-20",
        }}
        closeButton={false}
        isOpen={isOpen}
        size="2xl"
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg p-4">
                ...
                <div className="mt-3 p-2 bg-yellow-100 dark:bg-yellow-900/30 rounded-lg border border-yellow-300 dark:border-yellow-700">
                  <p className="text-xs text-yellow-800 dark:text-yellow-200 text-center">
                    <strong>⚠️ Importante:</strong> Leve documento com foto para
                    retirar o kit
                  </p>
                </div>
              </div>
          ...
          <div className="text-center mb-6 sm:mb-8">
            <div className="flex justify-center mb-4">
              <div className="bg-gradient-to-r from-pink-500 to-purple-600 p-4 sm:p-6 rounded-full shadow-lg">
                <RunnerIcon className="text-white sm:w-16 sm:h-16" size={48} />
              </div>
            </div>
            ...
            >
              <span className={title({ color: "pink", size: "md" })}>
                Inscrição
              </span>{" "}
              para a Corrida
            </h1>
            ...
            <div
              className={subtitle({
                class: "max-w-2xl mx-auto text-sm sm:text-base px-2",
              })}
            >
              Preencha todos os campos abaixo para realizar sua inscrição na 1ª
              Corrida e Caminhada Outubro Rosa - Projeto Jaíba
            </div>
          </div>
          ...
          <Card className="max-w-4xl mx-auto mb-6 sm:mb-8 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 border border-yellow-300 dark:border-yellow-700">
            <CardBody className="p-4 sm:p-6">
              ...
              <div className="space-y-2 text-xs sm:text-sm">
                ...
                <p>
                  • <strong>Comprovante:</strong> Obrigatório upload da imagem
                  no formulário
                </p>
                <p>
            ...
            <CardBody className="p-4 sm:p-6">
              ...
              <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                <p className="text-xs sm:text-sm text-yellow-800 dark:text-yellow-200 text-center">
                  <strong>⚠️ Importante:</strong> Leve um documento com foto
                  para retirar o kit
                </p>
              </div>
            </CardBody>
