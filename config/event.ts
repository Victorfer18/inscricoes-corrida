export const eventConfig = {
  ...
  mensagemInscricoesFinalizadas: "As inscrições para a 1ª Corrida Solidária Outubro Rosa foram encerradas!",
  mensagemEventoRealizado: "Obrigado a todos que participaram da nossa corrida! Acompanhe as fotos e resultados em nossas redes sociais.",
